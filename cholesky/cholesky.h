...
static void convert_to_blocks(const int ts, const int nt, const int N, double Alin[N][N], double *A[nt][nt])
{
	for (int i = 0; i < nt; i++)
		for (int j = 0; j < nt; j++) {
...
static void convert_to_linear(const int ts, const int nt, const int N, double *A[nt][nt], double Alin[N][N])
{
	for (int i = 0; i < nt; i++)
		for (int j = 0; j < nt; j++) {
